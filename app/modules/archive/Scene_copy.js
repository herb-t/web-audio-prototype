...
Scene.prototype.updateVisual = function() {
  ...
  // if (this.songBuffer) {
  //   this.tempTimer++;
  //   if ((this.tempTimer / 50) == parseInt((this.songBuffer.duration / 4), 10)) {
  //     visualElement.material.color.setHex(0x2dd88e);
  //     this.controls.autoRotate = true;
  //   }
  //   if ((this.tempTimer / 50) == parseInt((this.songBuffer.duration / 3), 10)) {
  //     visualElement.material.color.setHex(0xc42b2b);
  //     this.controls.autoRotate = true;
  //   }
  // }

  // this.rgbEffect.uniforms['amount'].value = average / 3000;
